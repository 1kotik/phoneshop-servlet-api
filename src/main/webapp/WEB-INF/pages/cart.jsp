...
<tags:master pageTitle="">
    ...
    <c:if test="${not empty cart.items}">
        <h1>Cart</h1>
        <form method="post" action="${pageContext.servletContext.contextPath}/cart/modify-cart">
            <table>
                <thead>
                <tr>
                    <td>Image</td>
                ...
                <c:forEach var="item" items="${cart.items}" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <button form="delete"
                                    formaction="${pageContext.servletContext.contextPath}/cart/modify-cart/${item.product.id}">
                                Delete
                            </button>
                        </td>
                    </tr>
